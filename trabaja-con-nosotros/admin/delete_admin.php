...
<!DOCTYPE html>
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col">
                    <!-- <label class="form-label"><h4>Esta acción no se puede revertir</h4></label> -->
                    <p class="alert alert-danger"><b>CUIDADO:</b> Se eliminarán definitivamente los datos de <?php echo $consulta[1] ?> </p>
                </div>
            </div>
            <!-- <div class="col-12"> 
            ...
            <form method="POST" action="logica/delete_admin_conf.php">
                <label class="form-label"><h1><b>DASHBOARD ADMINISTRATIVO</b></h1></label>
                <p> <i class="fas fa-user-shield"></i> Eliminar datos de administrador </p>
                ...
                <button type="submit" class="btn btn-success">ELIMINAR ADMINISTRADOR</button>
